                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" placeholder="Title" id="title" name="title" value="{{ $portfolio->title }}">
                                    @error('title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg mt-3" id="display_image" src="{{ asset($portfolio->image) }}" alt="Card image cap">
                                </div>
                            </div>
